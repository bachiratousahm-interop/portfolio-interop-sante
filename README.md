...
| [Projet 4](./Projet-4 IHE-XDS.b/) | **Partage documentaire XDS.b / MHD** | DMP, CI-SIS, PDSm, DRIMbox, DICOM KOS |
| [Projet 5](./Projet-5 Architecture d'integration/) | **Architecture d'intégration globale** | HL7 v2 → FHIR, Mirth, SMART on FHIR, architecture cible |
